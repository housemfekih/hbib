...
class TemplateController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
			...
			//$this->get('knp_snappy.image')->generate($this->render($this->getParameter('template_directory').'/'.$fileName.'.twig', array(
     
			//)),
		//	$this->getParameter('template_directory').'/'.'/'. $imageName 
            //);
            $this->get('knp_snappy.image')->generate('file:///home/houssem/Bureau/orbit-v1.0/orbit-v1.0/index.html',$this->getParameter('template_directory').'/'.'/'. $imageName );
